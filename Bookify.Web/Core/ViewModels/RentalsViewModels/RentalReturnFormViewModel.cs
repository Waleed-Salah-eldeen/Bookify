...
namespace Bookify.Web.Core.ViewModels.RentalsViewModels
{
    public class RentalReturnFormViewModel
    {
        ...
        [AssertThat("(TotalDelayInDays == 0 && PenaltyPaid == false) || PenaltyPaid == true", ErrorMessage = ErrorMessages.PenaltyShouldBePaid)]
