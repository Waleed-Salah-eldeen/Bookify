...
namespace Bookify.Web.Controllers
{
    ...
    public class RentalsController : Controller
    {
        ...
        public IActionResult MarkAsDeleted(int id)
        {
            ...
            var numberOfCopies = _context.RentalCopies.Count(r => r.RentalId == id);
